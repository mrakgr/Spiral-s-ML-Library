...
extern "C" __global__ void entry0(unsigned char * v0, unsigned char * v1) {
    ...
    float * v12;
    v12 = reinterpret_cast<float *>(&v0[512ull]);
    int v14;
    v14 = blockIdx.x;
    ...
    float * v24;
    v24 = reinterpret_cast<float *>(&v0[3584ull]);
    int v26;
    v26 = blockIdx.x;
    ...
    float * v30;
    v30 = reinterpret_cast<float *>(&v0[4608ull]);
    method_1(v30, v24);
    float * v32;
    v32 = reinterpret_cast<float *>(&v0[5632ull]);
    method_2(v32, v30);
    float * v34;
    v34 = reinterpret_cast<float *>(&v1[1536ull]);
    float * v36;
    v36 = reinterpret_cast<float *>(&v0[6656ull]);
    int v38;
    v38 = blockIdx.x;
    ...
    float * v42;
    v42 = reinterpret_cast<float *>(&v0[7680ull]);
    int * v44;
    v44 = reinterpret_cast<int *>(&v0[8704ull]);
...
extern "C" __global__ void entry1(unsigned char * v0, unsigned char * v1) {
    ...
    while (while_method_4(v8)){
        ...
        v14 = 128l * v8;
        float * v15;
        v15 = reinterpret_cast<float *>(&v0[512ull]);
        int v17;
        v17 = blockIdx.x;
        ...
        float * v21;
        v21 = reinterpret_cast<float *>(&v0[1536ull]);
        method_1(v21, v15);
        float * v23;
        v23 = reinterpret_cast<float *>(&v0[2560ull]);
        method_2(v23, v21);
        float * v25;
        ...
        v27 = 256l * v8;
        float * v28;
        v28 = reinterpret_cast<float *>(&v0[3584ull]);
        int v30;
        v30 = blockIdx.x;
        ...
        float * v34;
        v34 = reinterpret_cast<float *>(&v0[4608ull]);
        method_1(v34, v28);
        float * v36;
        v36 = reinterpret_cast<float *>(&v0[5632ull]);
        method_2(v36, v34);
        float * v38;
        v38 = reinterpret_cast<float *>(&v1[24576ull]);
        assert("Tensor range check" && 0 <= v8 && v8 < 16l);
        float * v40;
        v40 = reinterpret_cast<float *>(&v0[6656ull]);
        int v42;
        v42 = blockIdx.x;
        ...
        float * v46;
        v46 = reinterpret_cast<float *>(&v0[7680ull]);
        assert("Tensor range check" && 0 <= v8 && v8 < 16l);
        int * v48;
        v48 = reinterpret_cast<int *>(&v0[24064ull]);
        assert("Tensor range check" && 0 <= v8 && v8 < 16l);
        int v50;
        v50 = 16l * v8;
        method_7(v48, v50, v46, v27, v40, v7);
        v8 += 1l ;
    }
    return ;
}
extern "C" __global__ void entry2(unsigned char * v0, unsigned char * v1) {
    ...
    while (while_method_1(v8)){
        ...
        v14 = 67108864l * v8;
        float * v15;
        v15 = reinterpret_cast<float *>(&v0[1048576ull]);
        int v17;
        v17 = blockIdx.x;
        assert("Tensor range check" && 0 <= v17 && v17 < 1l);
        int v18;
        ...
        float * v21;
        v21 = reinterpret_cast<float *>(&v0[2097152ull]);
        assert("Tensor range check" && 0 <= v8 && v8 < 4l);
        int v23;
        v23 = 262144l * v8;
        int * v24;
        v24 = reinterpret_cast<int *>(&v0[6291456ull]);
        assert("Tensor range check" && 0 <= v8 && v8 < 4l);
        int v26;
        v26 = 32l * v8;
...
def method0() -> None:
    ...
    v5 = cp.empty(104,dtype=cp.uint8)
    del v5
    v8 = "{}\n"
    v9 = "---"
...
def method3() -> None:
    ...
    del v8, v155
    v157 = v5[0:0+4*2].view(cp.float32)
    del v5
    v158 = cp.random.normal(0.0,1.0,2,dtype=cp.float32) # type: ignore
    cp.copyto(v157[0:0+2],v158[0:0+2])
    del v158
    v186 = 0
    print(v44.format('['),end="")
    v187 = 0
...
def method5() -> None:
    ...
    v5 = cp.empty(8768,dtype=cp.uint8)
    ...
    print(v41.format(']'),end="")
    print(v63,end="")
    v151 = v5[0:0+4*128].view(cp.float32)
    v152 = cp.random.normal(0.0,1.0,128,dtype=cp.float32) # type: ignore
    cp.copyto(v151[0:0+128],v152[0:0+128])
    del v152
    v180 = 0
    print(v41.format('['),end="")
    v181 = 0
    ...
    del v214
    v215 = 0
    v216 = raw_module.get_function(f"entry{v215}")
    del v215
    v216.max_dynamic_shared_size_bytes = 1536 
    v216((1,),(32,),(v5, v4),shared_mem=1536)
    del v4, v216
    v218 = v5[7680:7680+4*256].view(cp.float32)
    v220 = v5[8704:8704+4*16].view(cp.int32)
    del v5
    v265 = 0
    print(v41.format('['),end="")
    v266 = 0
...
def method8() -> None:
    ...
    v5 = cp.empty(25088,dtype=cp.uint8)
    ...
    print(v49.format(']'),end="")
    print(v81,end="")
    v205 = v5[0:0+4*128].view(cp.float32)
    v206 = cp.random.normal(0.0,1.0,128,dtype=cp.float32) # type: ignore
    cp.copyto(v205[0:0+128],v206[0:0+128])
    del v206
    v234 = 0
    print(v49.format('['),end="")
    v235 = 0
    ...
    del v17, v268
    v269 = 1
    v270 = raw_module.get_function(f"entry{v269}")
    del v269
    v270.max_dynamic_shared_size_bytes = 1536 
    v270((1,),(32,),(v5, v4),shared_mem=1536)
    del v4, v270
    v272 = v5[24064:24064+4*256].view(cp.int32)
    del v5
    v306 = 0
    print(v49.format('['),end="")
    v307 = 0
    while method6(v307):
        v309 = v306
        v310 = v309 >= 2147483647
        del v309
        if v310:
            v311 = " ..."
            print(v49.format(v311),end="")
            del v311
            break
        else:
            pass
        ...
        while method4(v315):
            v317 = v306
            v318 = v317 >= 2147483647
            del v317
            if v318:
                v319 = " ..."
                print(v49.format(v319),end="")
                del v319
                break
            else:
                pass
            ...
            while method6(v323):
                v325 = v306
                v326 = v325 >= 2147483647
                del v325
                if v326:
                    v327 = " ..."
                    print(v49.format(v327),end="")
                    del v327
                    break
                else:
                    pass
...
def method9() -> None:
    ...
    v5 = cp.empty(6291968,dtype=cp.uint8)
    ...
    del v7, v8
    v10 = v5[0:0+4*262144].view(cp.float32)
    v11 = cp.random.normal(0.0,1.0,262144,dtype=cp.float32) # type: ignore
    cp.copyto(v10[0:0+262144],v11[0:0+262144])
    del v10, v11
    v12 = 2
    v13 = raw_module.get_function(f"entry{v12}")
    del v12
    v13.max_dynamic_shared_size_bytes = 1536 
    v13((1,),(32,),(v5, v4),shared_mem=1536)
    del v4, v13
    v15 = v5[6291456:6291456+4*128].view(cp.int32)
    del v5
    v51 = 0
    v52 = "{}"
