...
struct StackRefs2 {
    Eigen::Matrix<float,8,115,Eigen::RowMajor> & v1;
    Eigen::Matrix<float,8,48,Eigen::RowMajor> & v2;
    int & v0;
    __host__ __device__ StackRefs2() = default;
    __host__ __device__ StackRefs2(int & t0, Eigen::Matrix<float,8,115,Eigen::RowMajor> & t1, Eigen::Matrix<float,8,48,Eigen::RowMajor> & t2) : v0(t0), v1(t1), v2(t2) {}
};
