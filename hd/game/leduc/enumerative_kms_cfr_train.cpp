...
float method_14(xso::rng & v0, StackRefs2 & v1, StackRefs3 & v2, Union4 v3, bool v4, static_array<Union1,2> v5, int v6, static_array<int,2> v7, int v8, StackRefs0 & v9, StackRefs1 & v10, StackMut0 & v11, StackMut1 & v12){
    ...
    af::array & v71 = v10.v0;
    af::array & v72 = v10.v1;
    StackRefs4 v73{v68, v71, v72};
    StackRefs5 v74{v69, v70};
    method_16(v73, v74);
    int v75;
    v75 = v69.elements();
    float v76[v75];
    ...
    switch (v31.tag) {
        ...
        case 1: { // Some
            ...
            float v113;
            v113 = loop_12(v1, v9, v10, v0, v11, v2, v12, v112);
    ...
    switch (v26.tag) {
        ...
        case 1: { // Some
            ...
            Tuple2 tmp57 = v127[v6];
            v128 = tmp57.v0; v129 = tmp57.v1;
            ...
            float v142;
            v142 = loop_12(v1, v9, v10, v0, v11, v2, v12, v141);
    ...
    Tuple2 tmp58 = v155[v6];
    v156 = tmp58.v0; v157 = tmp58.v1;
    ...
    float v172;
    v172 = loop_12(v1, v9, v10, v0, v11, v2, v12, v171);
    ...
    v213 = tmp60.v0; v214 = tmp60.v1;
    while (while_method_1(v213)){
        float v216; float v217;
        Tuple2 tmp61 = v212[v213];
        v216 = tmp61.v0; v217 = tmp61.v1;
        bool v224;
        v224 = v213 == v6;
        float v225;
        if (v224){
    ...
    af::array v269;
    v269 = v268;
    StackRefs6 v270{v70, v269};
    StackRefs7 v271{v251};
    method_17(v270, v271);
    return v184;
}
...
int main() {
    ...
    while (while_method_7(v70, v71)){
        ...
        af::array & v152 = v8.v0;
        af::array & v153 = v8.v1;
        StackRefs4 v154{v149, v152, v153};
        StackRefs5 v155{v150, v151};
        method_16(v154, v155);
        unsigned int v156;
        v156 = v151.scalar<unsigned int>();
        printf("%u\n",v156);
        fflush(stdout);
        ++v71;
    }
