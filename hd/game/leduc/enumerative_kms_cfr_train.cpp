...
int main() {
    ...
    af::array & v14 = v8.v1;
    v14 = af::constant<float>(0, v14.dims());
    xso::rng v15;
    StackMut0 v16{63u};
    static_array_list<Union0,32> v17;
    v17 = static_array_list<Union0,32>{};
    StackRefs3 v21{v17};
    static_array<Tuple2,2> v22;
    int v26;
    v26 = 0;
    while (while_method_1(v26)){
        v22[v26] = Tuple2{0.0f, 0.0f};
        v26 += 1 ;
    }
    StackRefs4 v28{v22};
    int v29; float v30;
    ...
    while (while_method_2(v29)){
        ...
        v39 = Union3{Union3_1{}};
        float v40;
        v40 = body_0(v21, v3, v8, v15, v16, v28, v39);
        v30 = v40;
        v29 += 1 ;
    }
    xso::rng v41;
    ...
    v43 = static_array_list<Union0,32>{};
    StackRefs3 v47{v43};
    static_array<Tuple2,2> v48;
    int v52;
    v52 = 0;
    while (while_method_1(v52)){
        v48[v52] = Tuple2{0.0f, 0.0f};
        v52 += 1 ;
    }
    StackRefs4 v54{v48};
    int v55; float v56;
    Tuple3 tmp30 = Tuple3{0, 0.0f};
    v55 = tmp30.v0; v56 = tmp30.v1;
    while (while_method_7(v55)){
        ...
        v65 = Union3{Union3_1{}};
        float v66;
        v66 = body_15(v47, v3, v8, v41, v42, v54, v65);
        v56 = v66;
        v55 += 1 ;
    }
    printf("{%s = %f}\n","reward_for_pl0", v56);
