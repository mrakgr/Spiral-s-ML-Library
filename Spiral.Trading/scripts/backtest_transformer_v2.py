#!/usr/bin/env python3
"""Backtest using Transformer v2 model."""
...
from train_transformer_v2 import TradingTransformerV2
...
def main():
    ...
    model.load_state_dict(torch.load('data/transformer_v2_model.pt'))
    ...
    for day_idx in day_indices:
        ...
        plot_backtest(result, day_idx, f'data/backtest_transformer_v2_day{day_idx}.png')
