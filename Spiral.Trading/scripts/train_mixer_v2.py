#!/usr/bin/env python3
"""MLP-Mixer v2 - unified mixer processing all timeframes together."""
...
class TradingMixerV2(nn.Module):
    """
    Unified MLP-Mixer - concatenates all timeframes and processes together.
    ...
    def forward(self, x_1s, x_1m, x_5m):
        # Concatenate all timeframes: (batch, 198, 4)
...
def main():
    ...
    model = TradingMixerV2().to(device)
    ...
    torch.save(model.state_dict(), 'data/mixer_v2_model.pt')
    print("\nSaved model to data/mixer_v2_model.pt")
