#!/usr/bin/env python3
"""Backtest using MLP-Mixer v2 model."""
...
from train_mixer_v2 import TradingMixerV2
...
def main():
    ...
    model.load_state_dict(torch.load('data/mixer_v2_model.pt'))
    ...
    for day_idx in day_indices:
        ...
        plot_backtest(result, day_idx, f'data/backtest_mixer_v2_day{day_idx}.png')
